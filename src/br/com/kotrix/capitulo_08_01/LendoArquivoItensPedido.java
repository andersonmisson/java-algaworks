package br.com.kotrix.capitulo_08_01;
...
public class LendoArquivoItensPedido {
	...
	public static void main(String[] args) {
		...
		try (Scanner scanner = new Scanner(new BufferedReader(new FileReader("itens_pedido.txt")))) {
			// O que delimita por padrão é o espaço, aqui eu avisei que era o ";"
			scanner.useDelimiter(";");
			// Para usar a virgula nos numero Brasileiros
			Locale localeBrasil = new Locale("pt", "BR");
			scanner.useLocale(localeBrasil);
			// Aqui é para colocar R$ antes dos valores
			...
			while (scanner.hasNext()) {
				...
				scanner.nextLine(); // Se não colocar esse NextLine dentro do laço, ficara bagunçado
