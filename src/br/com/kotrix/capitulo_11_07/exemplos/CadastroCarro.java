package br.com.kotrix.capitulo_11_07.exemplos;

import java.time.Year;
import java.util.Arrays;
import java.util.List;

import br.com.kotrix.capitulo_11_06.model.Carro;
...
public class CadastroCarro {
	...
	carros.stream()
		.filter(c -> c.getAnoFabricacao().isAfter(Year.of(2012))) // isAfter é muito interessante
